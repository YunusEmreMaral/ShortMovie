...
$(window).on('load', function () {
	...
	var body = $('body');
	status.add(preloader).fadeOut('fast', function () { // Combine status and preloader fadeOut
		body.css('overflow', 'visible'); // Apply overflow visible when preloader fades out
	});
